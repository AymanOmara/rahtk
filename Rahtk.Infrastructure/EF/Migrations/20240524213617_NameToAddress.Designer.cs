...
namespace Rahtk.Infrastructure.EF.Migrations
{
    ...
    [Migration("20240524213617_NameToAddress")]
    partial class NameToAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rahtk.Domain.Features.User.AddressEntity", b =>
                {
                    ...
                    b.Property<int>("RahtkUserId")
                        .HasColumnType("int");

                    b.Property<string>("RahtkUserId1")
                        .HasColumnType("nvarchar(450)");

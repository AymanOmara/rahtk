...
namespace Rahtk.Infrastructure.EF.Migrations
{
    ...
    [Migration("20240613223249_UpdateReminderPharmacy")]
    partial class UpdateReminderPharmacy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rahtk.Domain.Features.Product.FavoriteProductUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rahtk.Domain.Features.Product.ProductEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ReminderEntityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rahtk.Domain.Features.Order.OrderItemEntity", b =>
                {
                    ...
                    b.HasOne("Rahtk.Domain.Features.Product.ProductEntity", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Rahtk.Domain.Features.Product.ProductEntity", b =>
                {
                    ...
                    b.HasOne("Rahtk.Domain.Features.Reminder.ReminderEntity", null)
                        .WithMany("Products")
                        .HasForeignKey("ReminderEntityId");
